...
const MAPTILER_KEY = "LIrIBVdY1C3aCgd9pexM";
const GEOAPIFY_KEY = "0df1db71ebcd4be392e29c497fe1926e";
...
map.on('click', async (e) => {
    ...
    try {
        const url = `https://api.geoapify.com/v2/place-details?lat=${lat}&lon=${lng}&apiKey=${GEOAPIFY_KEY}`;
